...
export default function SimpleNavbarWithHoverEffects() {
  return (
    <div className="bg-neutral-100 dark:bg-neutral-900 sticky inset-x-0 top-0 z-60">
      <Navbar />
    </div>
  );
}
...
const MobileNav = ({ navItems }: any) => {
  ...
  return (
    <>
      <motion.div
        key={String(open)}
        className="relative mx-auto flex w-full flex-col items-center justify-between bg-white px-4 py-2 lg:hidden dark:bg-neutral-950"
      >
